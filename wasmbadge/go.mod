module github.com/hybridgroup/mechanoid-examples/wasmbadge

go 1.22.0

replace (
	github.com/hybridgroup/mechanoid => ../../mechanoid
...
require (
	...
	github.com/hybridgroup/mechanoid v0.0.0-20240301084957-59def5e0379
